...
$(document).ready(function () {
    ...
    dtList = new Tabulator("#dt-list", {
        columns: [
            {
                ...
                title: "Nama <br/>Pelatihan", field: "nm_training", sorter: "string",
                width: "13%", headerFilter: "input"
            },{
                title: "Tanggal <br/>Mulai", field: "tgl_start_tr", sorter: "string",
                width: "10%", headerFilter: "input", align: "center"
            },{
                title: "Tanggal <br/>Akhir", field: "tgl_end_tr", sorter: "string",
                width: "10%", headerFilter: "input", align: "center"
            },{
                title: "Jml <br/>Hari", field: "jml", sorter: "string",
                width: "6%", align :"center"
            },{
                title: "Nama <br/>Penyedia", field: "nm_lembaga", sorter: "string",
        ...
        ajaxURL: base_url + "presensi/pelatihan/lists",
        ajaxConfig: "POST",
        ajaxSorting: true,
        ajaxFiltering: true,
    ...
    btnExport.on('click', function (e) {
        ...
        if(start_date == '' || end_date == ''){
            ...
            var url = base_url + "presensi/pelatihan/getExportExcel/"+start_date+"/"+end_date;
