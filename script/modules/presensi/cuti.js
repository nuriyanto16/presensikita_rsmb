...
$(document).ready(function () {
    ...
    dtList = new Tabulator("#dt-list", {
        columns: [
            {
                ...
                title: "Jenis <br/>Pengajuan", field: "cuti_desc", sorter: "string",
                width: "13%", headerFilter: "input"
            },{
                title: "Tanggal <br/>Mulai", field: "tgl_awal_cuti", sorter: "string",
                width: "10%", headerFilter: "input", align: "center"
            },{
                title: "Tanggal <br/>Akhir", field: "tgl_akhir_cuti", sorter: "string",
                width: "10%", headerFilter: "input", align: "center"
            },{
                title: "Jml <br/>Hari", field: "jml", sorter: "string",
                width: "6%", align :"center"
            },{
                title: "Keterangan <br/>&nbsp;", field: "alasan_cuti", sorter: "string",
        ...
        ajaxURL: base_url + "presensi/cuti/lists",
        ajaxConfig: "POST",
        ajaxSorting: true,
        ajaxFiltering: true,
    ...
    btnExport.on('click', function (e) {
        ...
        if(start_date == '' || end_date == ''){
            ...
            var url = base_url + "presensi/cuti/getExportExcel/"+start_date+"/"+end_date;
