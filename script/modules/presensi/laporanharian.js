...
$(document).ready(function () {
    dtList = new Tabulator("#dt-list", {
        columns: [
            {
                ...
                title: "Tanggal <br/>", field: "tgl_awal_izin", sorter: "string",
                ...
                title: "Deskripsi Pekerjaan <br/>&nbsp;", field: "alasan_izin", sorter: "string",
        ...
        ajaxURL: base_url + "presensi/laporanharian/lists",
        ajaxConfig: "POST",
        ajaxSorting: true,
        ajaxFiltering: true,
