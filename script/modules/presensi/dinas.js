...
$(document).ready(function () {
    ...
    dtList = new Tabulator("#dt-list", {
        columns: [
            {
                ...
                title: "Tujuan <br/>&nbsp;", field: "tujuan", sorter: "string",
                width: "13%", headerFilter: "input"
            },{
                title: "Tanggal <br/>Mulai", field: "tgl_brkt", sorter: "string",
                width: "10%", headerFilter: "input", align: "center"
            },{
                title: "Tanggal <br/>Akhir", field: "tgl_plng", sorter: "string",
                width: "10%", headerFilter: "input", align: "center"
            },{
                title: "Jml <br/>Hari", field: "jml", sorter: "string",
                width: "6%", align :"center"
            },{
                title: "Keperluan <br/>&nbsp;", field: "keperluan", sorter: "string",
                width: "13%", headerFilter: "input"
            },{
        ...
        ajaxURL: base_url + "presensi/dinas/lists",
        ajaxConfig: "POST",
        ajaxSorting: true,
        ajaxFiltering: true,
    ...
    btnExport.on('click', function (e) {
        ...
        if(start_date == '' || end_date == ''){
            ...
            var url = base_url + "presensi/dinas/getExportExcel/"+start_date+"/"+end_date;
