...
$(document).ready(function () {
    let dtList = new Tabulator("#dt-list", {
        columns: [
            ...
            {
                title: "Kode Perusahaan", field: "COMP_CODE", sorter: "string",
                width: "15%"
            },
            {
                title: "Nama Perusahaan", field: "COMP_NAME", sorter: "string",
                width: "50%"
            },
            {
                title: "Alamat", field: "ALAMAT", sorter: "string", formatter:"textarea",
                width: "25%"
            }
        ],
        locale: 'id',
        ajaxURL: base_url + "reference/company/lists",
        ajaxConfig: "POST",
        ajaxSorting: true,
        ajaxFiltering: true,
