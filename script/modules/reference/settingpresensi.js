        ...
        columns: [
            {
                ...
                title: "Nama Presensi", field: "remark", sorter: "string",
                width: "20%", headerFilter: "input"
            },{
                title: "Tanggal Awal", field: "start_date", sorter: "string",
                width: "20%", headerFilter: "input"
            },{
                title: "Tanggal AKhir", field: "end_date", sorter: "string",
                width: "20%", headerFilter: "input"
            }
        ],
        locale: 'id',
        placeholder: "Tidak ada data",
        ajaxURL: base_url + "reference/settingpresensi/lists",
        ajaxConfig: "POST",
        ajaxSorting: true,
        ajaxFiltering: true,
