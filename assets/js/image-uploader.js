...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, id) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                $idImg = $img.attr('id', "myImg-"+id).appendTo($container),
                $classImg = $img.attr('class', "myImg").appendTo($container),
                $funcImg = $img.attr('onclick', "showZoom('myImg-"+id+"')").appendTo($container),
    ...
    //MODAL ZOOM
    function showZoom(idImg){

        // Get the modal

        var modal = document.getElementById("myModalZoomImg");
