...
*/
$config['tables']['users']           = config_item('table_user');
$config['tables']['groups']          = 'sec_role';
$config['tables']['users_groups']    = 'sec_user_role';
$config['tables']['login_attempts']  = 'sec_login_attempts';
/*
...
$config['sess_prefix']    = 'pihc_manrisk_';
 ...
 */
$config['site_title']                 = "PRESENSI KITA";       // Site Title, example.com
$config['admin_email']                = "info@mitrasinerji.com"; // Admin Email, admin@example.com
$config['default_group']              = 'registered';        // 3 Default group, use name
$config['admin_group']                = 'admin';             // 2 Default administrators group, use name
$config['superadmin_group']           = 'superadmin';        // 1 Default super administrators group, use name
$config['identity']                   = 'username';          // A database column which is used to login with username or email
