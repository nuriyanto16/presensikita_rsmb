...
define('BASE_HOST', $base_url);
define('BASE_URL', $config['base_url']);
define('HTTP_ASSET_PATH', $config['base_url'].'assets/');
define('HTTP_ASSET_IMG', $config['base_url'].'assets/images/');
define('HTTP_UPLOAD_DIR', $config['base_url'].'uploadfile/');
define('HTTP_JS_PATH', $config['base_url'].'assets/js/');
define('HTTP_MOD_JS', $config['base_url'].'script/');

define('BASE_UPLOAD_PATH', 'uploadfile');


//$config['base_url'] = 'http://seuneu.trisula.com/';
//define('upload_path', '/var/www/seuneu.trisula.com/html/uploads/');
...
define('smtp_host', '192.168.1.235');
define('smtp_port', 25);
define('smtp_user', '');
define('smtp_pass', '');
define('enableSsl', false);
define('email_sender', 'mytrisula@trisula.com');

/*END SETTING EMAIL CONFIG*/
...
$config['sess_cookie_name'] = 'presensikitabackmhdyh_sess';
...
$config['csrf_token_name'] = 'frsc_presensikitamhdyh_tn';
$config['csrf_cookie_name'] = 'frsc_presensikitamhdyh_cn';
