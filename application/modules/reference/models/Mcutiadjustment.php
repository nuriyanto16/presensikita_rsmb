...
/**
 * Class Mcutiadjustment
 */
class Mcutiadjustment extends Mst_model
{
    ...
    {
        parent::__construct();
        $this->table = config_item("table_cuti_adjustment");
    }

    function get($id = null, $offset = null, $limit = null, $order = null, $filters = null)
    {
        $this->db->select("a.seq, a.comp_code, a.nik, a.periode, a.remark_adj, a.jml_cuti"
                      . ", DATE_FORMAT(a.start_adj, '%d-%m-%Y') AS start_adj, DATE_FORMAT(a.end_adj, '%d-%m-%Y') AS end_adj,"
