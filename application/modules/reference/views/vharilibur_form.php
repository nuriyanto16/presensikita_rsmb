        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <div
                            class="form-group col-md-12 <?php if (!empty(form_error('tanggal'))) echo 'has-error'; ?>">
                            <?php echo form_label('Tanggal Libur ', 'tanggal', $label);
                            echo form_input(isset($tanggal) ? $tanggal : "");
                            ?>
                        </div><!-- /.form-group -->
                    </div>
                    ...
                    <div class="row">
                        <div
                            class="form-group col-md-12 <?php if (!empty(form_error('keterangan'))) echo 'has-error'; ?>">
                            <?php echo form_label('Keterangan * ', 'keterangan', $label);
                            echo form_input(isset($keterangan) ? $keterangan : "");
                            ?>
                        </div><!-- /.form-group -->
                    </div>
                    ...
                    <div class="form-group">
                        <a href="<?php echo site_url("reference/harilibur") ?>"
