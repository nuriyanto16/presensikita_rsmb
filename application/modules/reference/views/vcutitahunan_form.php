        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <div
                            class="form-group col-md-12 <?php if (!empty(form_error('jml_cuti'))) echo 'has-error'; ?>">
                            <?php echo form_label('Jumlah Cuti Tahunan ', 'jml_cuti', $label);
                            echo form_input(isset($jml_cuti) ? $jml_cuti : "");
                            ?>
                        </div><!-- /.form-group -->
                    </div>
