    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        <div class="col-md-3" style="float: left;">
                            ...
                            <!-- <form action="<?php echo base_url('reference/position/sinkronJabatan'); ?>" method="get">
                                <button type="submit" value="Submit" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>
                                    Sinkronisasi Data Jabatan dari SIMRS
                                </button>
                            </form>  -->
                            <?php } ?>
                        </div>
                ...
                <div class="x_title">
                    <a href="<?php echo (!$_new) ? "#" : base_url('reference/position/edit_form'); ?>"
