        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <div
                            class="form-group col-md-6 <?php if (!empty(form_error('costcenter_code'))) echo 'has-error'; ?>">
                            <?php
                            echo form_label('Cost Center *', 'costcenter_code', $label);
                            echo form_input(isset($costcenter_code) ? $costcenter_code : "");
                            ?>
                        </div><!-- /.form-group -->
                    </div>
                    ...
                    <div class="row">
                        <div
                            class="form-group col-md-12 <?php if (!empty(form_error('costcenter_desc'))) echo 'has-error'; ?>">
                            <?php echo form_label('Deskripsi', 'costcenter_desc', $label);
                            echo form_input(isset($costcenter_desc) ? $costcenter_desc : "");
                            ?>
                        </div><!-- /.form-group -->
                    </div>
                    ...
                    <div class="form-group">
                        <a href="<?php echo site_url("reference/costcenter") ?>"
