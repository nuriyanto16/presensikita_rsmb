                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <div
                            ...
                            <?php echo form_label('Periode (Tahun) *', 'periode_risiko_id', $label); ?>
                            <?php echo form_dropdown(isset($periode_risiko_id) ? $periode_risiko_id : "")  ?>
                        </div><!-- /.form-group -->
                        <div
                            class="form-group col-md-6 <?php if (!empty(form_error('periode_bulan'))) echo 'has-error'; ?>">
                            <?php echo form_label('Periode (Bulan) *', 'periode_bulan', $label); ?>
                            <?php echo form_dropdown(isset($periode_bulan) ? $periode_bulan : "")  ?>
                        </div><!-- /.form-group -->
