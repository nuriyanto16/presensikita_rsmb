        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <div
                            class="form-group col-md-12 <?php if (!empty(form_error('periode_nama'))) echo 'has-error'; ?>">
                            <?php echo form_label('Periode Nama *', 'periode_nama', $label); ?>
                            <?php echo form_input(isset($periode_nama) ? $periode_nama : ""); ?>
                        </div><!-- /.form-group -->
                    </div>
                    ...
                    <div class="row">
                        <div
                            ...
                            <?php echo form_label('Start Date', 'start_date', $label); ?>
                        ...
                        <div
                            ...
                            <?php echo form_label('End Date', 'end_date', $label); ?>
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
