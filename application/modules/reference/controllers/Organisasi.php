 ...
 */
class Organisasi extends Mst_controller
{
    ...
    {
        $this->data['titlehead'] = "Organisasi";

        $loadfoot['javascript'] = array(
            HTTP_MOD_JS . 'modules/reference/organisasi.js'
        );
        ...
        $this->_render_page('vorganisasi_list', $this->data, false, 'tmpl/vwbacktmpl');
    }
    ...
    public function lists()
    {
        ...
        foreach ($results as $row) {
            ...
            if ($this->_delete) {
                $atr_del['title'] = 'Hapus';
                $atr_del['url'] = 'reference/organisasi/delete/';
                $atr_del['class'] = '';
