 ...
 * Class Mgantibiaya
 */
class Mgantibiaya extends Mst_model
{
    ...
    function get($id = null, $offset = null, $limit = null, $order = null, $filters = null)
    {
        $this->db->select("a.id_aju, date_format(a.tgl_aju, '%d-%m-%Y') AS tgl_aju, 
                            ...
                            date_format(d.tgl_kuitansi, '%d-%m-%Y') AS tgl_kuitansi, 
                            d.ket_gantib, d.nom_kuitansi, d.jns_gantib, c.desc_gantib,
                            a.app_nik, a.app_ket, a.nik AS emp_nik");
        $this->db->from("{$this->table} a");
        $this->db->join('z_jns_aju b','a.jns_aju=b.jns_aju');
        $this->db->join('z_r_gantib d','a.id_aju=d.id_aju');
        $this->db->join('z_jns_gantib c','c.jns_gantib=d.jns_gantib');
    ...
    public function InsUpdPengobatan($pengajuan_id = null, $nik= null, $comp_code= null, $periode= null, $jam= null, $pengobatan_id= null, $nama_kuitansi= null, $ket_gantib= null, $nominal= null, $nilai_diganti= null, $cnt_file=null, $params_image_input=null) 
    {
        $sql = "CALL Z_P_SIMPAN_GANTIB(?,?,?,?,?,?,?,?,?,?,?,?)";
        $res = $this->db->query($sql,array($pengajuan_id, $nik, $comp_code, $periode, $jam, $pengobatan_id, $nama_kuitansi, $ket_gantib, $nominal, $nilai_diganti, $cnt_file, $params_image_input));
        $result = $res->result();
