 ...
 */
class Absensi extends Mst_controller
{
    ...
    {
        $this->data['titlehead'] = "Log Absensi";
    ...
    function tarikDataAbensi(){
        ...
        if($start_date != '' && $end_date  != ''){
	        ...
	        $params = 'http://192.168.1.84:8080/api/finger/tft/attendance?start_date='.$start_date.'&end_date='.$end_date.'';
            ...
            foreach($res['fp'] as $row){
                ...
                $tglinput = substr($row['time'], 0, 10);
    
                $execAbs = $this->mabs->insertLogAbsensi($machine_id, $ip, $port, $fid, $verification_mode, $work_code, $in_out_mode, $tanggal, $created_date, $tglinput);
