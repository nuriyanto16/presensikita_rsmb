...
class Izin extends Mst_controller
{
    ...
    function __construct()
    {
        ...
        $this->MOD_ALIAS = "MOD_PRESENSI_IZIN";
    ...
    {
        $this->data['titlehead'] = "Izin/Sakit";

        $loadfoot['javascript'] = array(
            HTTP_MOD_JS . 'modules/presensi/izin.js'
        );
        ...
        $this->_render_page('vizin_list', $this->data, false, 'tmpl/vwbacktmpl');
...
//                anchor("reference/position/activate/{$id}    ", "<i class='fa fa-times text-red'>&nbsp;</i>", array("onclick" => "return confirm('Aktifkan data ?');"));
    ...
    public function edit_form()
    {
            ...
            if ($this->form_validation->run($this) === TRUE) {
               ...
               //check to see if we are updating data
                ...
                if ($isError) {
                    ...
                    redirect("presensi/izin", 'refresh');
                }
            } else {
        ...
        $loadfoot['javascript'] = array(
            HTTP_MOD_JS . 'modules/presensi/izin_form.js',
        ...
        $list_jenisizin[null] = "Pilih Tipe Izin";
        ...
        return $this->_render_page('presensi/vizin_form', $this->data, false, 'tmpl/vwbacktmpl');
    }
    ...
    public function getExportExcel($fromDate=null, $toDate=null) {
        ...
        $html = $this->load->view("vizin_export", $this->data, true);
