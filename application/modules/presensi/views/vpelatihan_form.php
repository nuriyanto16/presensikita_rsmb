            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div style="<?= $style_disabled ?>">
                        ...
                        <div class="row">
                            <div
                                class="form-group col-md-6 <?php if (!empty(form_error('tgl_start_tr'))) echo 'has-error'; ?>">
                                <?php echo form_label('Tanggal Mulai *', 'tgl_start_tr', $label); ?>
                                <?php echo form_input(isset($tgl_start_tr) ? $tgl_start_tr : ""); ?>
                            </div><!-- /.form-group -->
                            <div
                                class="form-group col-md-6 <?php if (!empty(form_error('tgl_end_tr'))) echo 'has-error'; ?>">
                                <?php echo form_label('Tanggal Akhir *', 'tgl_end_tr', $label); ?>
                                <?php echo form_input(isset($tgl_end_tr) ? $tgl_end_tr : ""); ?>
                            </div><!-- /.form-group -->
                        </div>
                        ...
                        <div class="row">
                            <div 
                                class="form-group col-md-12  <?php if (!empty(form_error('nm_training'))) echo 'has-error'; ?>">
                                    <?php echo form_label('Nama Training *', 'nm_training', $label); ?>
                                    <?php echo isset($nm_training) ? form_textarea($nm_training) : ""; ?>
                            </div>
                        </div>

                        <div class="row">
                            <div 
                                class="form-group col-md-12  <?php if (!empty(form_error('nm_lembaga'))) echo 'has-error'; ?>">
                                    <?php echo form_label('Nama Lembaga *', 'nm_lembaga', $label); ?>
                                    <?php echo isset($nm_lembaga) ? form_textarea($nm_lembaga) : ""; ?>
                            </div>
                        </div>

                        <div class="row">
                            <div 
                                class="form-group col-md-12  <?php if (!empty(form_error('tempat_tr'))) echo 'has-error'; ?>">
                                    <?php echo form_label('Tempat Training *', 'tempat_tr', $label); ?>
                                    <?php echo isset($tempat_tr) ? form_textarea($tempat_tr) : ""; ?>
                            </div>
                        </div>
