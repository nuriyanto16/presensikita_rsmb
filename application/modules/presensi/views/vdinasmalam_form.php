            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div style="<?= $style_disabled ?>">
                        ...
                        <div class="row">
                            <div
                                ...
                                <?php echo form_label('Tipe Pengajuan *', 'id_abs_type', $label); ?>
                        ...
                        <div class="row">
                            <div 
                                class="form-group col-md-12  <?php if (!empty(form_error('remark'))) echo 'has-error'; ?>">
                                    <?php echo form_label('Keterangan *', 'remark', $label); ?>
                        ...
                        <div class="row">
                            <div
                                ...
                                <?php echo form_label('Tanggal Mulai *', 'start_date', $label); ?>
                        ...
                        <div class="row">
                            <div
                                ...
                                <?php echo form_label('Jumlah Hari Pengajuan ', 'jml', $label);
                    ...
                    <div class="form-group">
                        <a href="<?php echo site_url("presensi/dinasmalam") ?>"
