            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div style="<?= $style_disabled ?>">
                        ...
                        <div class="row">
                            <div
                                class="form-group col-md-12 <?php if (!empty(form_error('jenis_reimburse_id'))) echo 'has-error'; ?>">
                                <?php echo form_label('Tipe Penggantian *', 'jenis_reimburse_id', $label); ?>
                                <?php echo form_dropdown(isset($jenis_reimburse_id) ? $jenis_reimburse_id : "") ?>
                            </div>
                        </div>
                   
                        <div class="row">
                            <div 
                                class="form-group col-md-12  <?php if (!empty(form_error('ket_gantib'))) echo 'has-error'; ?>">
                                    <?php echo form_label('Keterangan *', 'ket_gantib', $label); ?>
                                    <?php echo isset($ket_gantib) ? form_textarea($ket_gantib) : ""; ?>
                            </div>
                        </div>
