...
<body>
    ...
    <strong>LAPORAN IZIN/SAKIT</strong><br/>
            ...
            foreach($res as $row){
                ...
                <table style="border: none;"> 
                    ...
                    <tr style="border: none;">
                        ...
                        <td style="border: none;" colspan="10">: <?= $row->desc_izin; ?></td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;">Tanggal Mulai</td>
                        <td style="border: none;" colspan="10">: <?= $row->tgl_awal_izin; ?></td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;">Tanggal Akhir</td>
                        <td style="border: none;" colspan="10">: <?= $row->tgl_akhir_izin; ?></td>
                    </tr>
                    <tr style="border: none;">
                    ...
                    <tr style="border: none;">
                        ...
                        <td style="border: none;" colspan="10">: <?= $row->alasan_izin; ?></td>
                    </tr>
