...
class Ion_auth_model extends CI_Model
{
    ...
    public function login($identity, $password, $remember = FALSE)
    {
        ...
        $query = $this->db->select('a.id, a.username, a.email, a.password, a.nik, a.active, a.last_login, a.full_name, a.phone,
                                    a.created_date, b.role_id, c.role_name, c.role_alias, emp.compId,
...
//            ->join(config_item('table_site') . ' e', 'e.siteId=d.siteId', 'left')
        ...
        if ($query->num_rows() === 1) {
            ...
            if ($password === TRUE) {
                ...
                $this->mcommon->setLog($user->id, 'MOD_LOGIN', $user->id, "Login");
...
//        $this->db->delete($this->tables['users_profile'], array('userid' => $id));
    ...
    public function login_remembered_user()
    {
         ...
         * ->get($this->tables['users']);
         **/
        $query = $this->db->select('a.' . $this->identity_column . ', a.username, a.nik, a.email, a.id, a.full_name, a.last_login,
