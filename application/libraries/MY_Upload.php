...
/*
 * https://github.com/iwane021/codeigniter-multi-upload
 */
...
class MY_Upload extends CI_Upload
{
    ...
    public function do_upload($field = 'userfile') {
        ...
        {
            $files = $_FILES[$field];            
            //$_newfilename = time()."_".$files['name'][0] . "_";
            $_newfilename = $files['name'][0];
            $_FILES[$field]['name'] = $_newfilename; //$files['name'][0]; add datetime to filename by kiQ
        ...
        else
        {
            ...
            {
                //$_newfilename = time()."_". $files['name'][$key];                
                $_newfilename = $files['name'][$key];                
                $_FILES[$field]['name'] = $_newfilename; ; //$files['name'][$key]; add datetime to filename by kiQ
                ...
                if ($this->do_upload($field))
                {
                    ...
                    $this->uploadedFiles[] = $return_data;
                }
                else
                {
