...
class Simplecaptcha {
    ...
    public $session_var = 'coolcaptcha';
    ...
    public function __construct($config = array()) {
        ...
        $this->resourcesPath = dirname(__FILE__) . DIRECTORY_SEPARATOR . $this->resourcesPath; 
		// OS WIN use dir separator with '\\'
        // OS LINUX use dir separator with '/'
...
/* End of file Coolcaptcha.php */
/* Location: ./system/application/libraries/Coolcaptcha.php */